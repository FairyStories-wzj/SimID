"""
The DenseNet code which is not originally written by the authors, but copied from https://github.com/pytorch/vision/blob/main/torchvision/models/densenet.py
